...
// api/synthesize-thread.ts
var apiSynthesizeThreadHandler = async (req, res) => {
  if (req.method !== "POST") {
...
var synthesize_thread_default = apiSynthesizeThreadHandler;
export {
  synthesize_thread_default as default
};
