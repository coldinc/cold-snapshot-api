...
const synthesizeHandler = async (req: any, res: any) => {
    ...
    if (req.method === "GET") {
        try {
            ...
            const latestSnapshot = latestSnapshotRecords[0] ? latestSnapshotRecords[0].fields : null;
...
module.exports = synthesizeHandler;