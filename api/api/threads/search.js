...
// lib/airtableSearch.ts
init_esm_shims();
import axios from "axios";
async function airtableSearch(tableName, filterFormula) {
  const { airtableToken, baseId } = airtableBase_default();
  if (!airtableToken || !baseId) {
...
function createSearchHandler({ tableName, fieldName, queryParam }) {
...
// api/threads/search.ts
var apiThreadsSearchHandler = async (req, res) => {
  const { TABLES } = airtableBase_default();
...
var search_default = apiThreadsSearchHandler;
export {
