...
var require_stringUtils = __commonJS({
  "lib/stringUtils.ts"(exports2, module2) {
    "use strict";
    ...
    module2.exports = { normalizeString, isMatch };
  }
});
...
var threadsSearchHandler = async (req, res) => {
  ...
  try {
    ...
    const matchingRecords = response.data.records.filter(
      (record) => isMatch(record.fields?.[fieldMap["Title"]] || "", title)
    );
